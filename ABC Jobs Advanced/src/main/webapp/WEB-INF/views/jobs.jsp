    ...
    <%@ include file="../components/navbar.jsp" %>
        ...
        <div class="container my-3 ">
            <ul class="nav nav-pills border-bottom border-primary">
                <li class="nav-item ">
                    <a class="nav-link fw-bold active" aria-current="page" href="#"><b>Jobs</b></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link fw-bold text-secondary" href="my-job"><b>My Job</b></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link fw-bold text-secondary" href="apply-job"><b>Apply Job</b></a>
                </li>
            </ul>
            ...
            <div class="search-bar mt-3">
                <form action="jobs-search" method="get" class="d-flex">
                    ...
                    <button class="btn btn-outline-dark h-6" type="submit"><b>Search</b></button>
                </form>
            </div>


            <div class="row row-cols-1 row-cols-md-2 g-4 mt-3" style=background-color:silver;font-weight:bold;>
                    ...
                    <div class="col">
                        <div class="card p-3 d-flex">
                            <div class="wrapper d-flex align-items-center me-3">
                                ...
                                <div class="detail">
                                    <h5 class="fw-semibold"><b>${job.getJob_name()}</b></h5>
                                    <h5 class="text-secondary fs-6"><b>${job.getCompany_name()}</b></h5>
                            ...
                            <div class="Job-description mt-4" style=color:red;>
