        ...
        <%@ include file="../components/navbar.jsp" %>
            ...
            <div class="container my-3 ">
                <ul class="nav nav-pills border-bottom border-primary">
                    <li class="nav-item ">
                        <a class="nav-link text-secondary fw-bold " href="threads"><b>Posts</b></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fw-bold active" aria-current="page" href="my-thread"><b>My Post</b></a>
                    </li>
                </ul>
                            ...
                            <div class="card p-3 d-flex">
                                ...
                                <div class="my-3 text-end">
                                    <button
                                        ...
                                        class="btn btn-outline-secondary"><b>Edit</b></button>
                                    <button
